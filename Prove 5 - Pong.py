...
class Velocity:
    def __init__(self):
        self.dx = 5 
        self.dy = 5 
#This is creating a class for the ball and its properties
class Ball:
    def __init__(self):
        self.center = Point()
        self.center.x = 0
...
#This is drawing the ball        
    def draw(self):
        arcade.draw_circle_filled(self.center.x, self.center.y, BALL_RADIUS, arcade.color.BLACK)
#This is advancing the ball across the screen        
    def advance(self):
        self.center.x += self.velocity.dx
        self.center.y += self.velocity.dy
#This is causing the ball to bounce horizantily and vertically            
    def bounce_horizontal(self):
        self.velocity.dx = self.velocity.dx * (-1)
            
    def bounce_vertical(self):
        self.velocity.dy = self.velocity.dy * (-1)
#This is is to restart the ball when it goes past the paddle        
    def restart(self):
        self.__init__()
     
# This creates the paddle class and its properties    
class Paddle:
    def __init__(self):
        self.center = Point()
        ...
        self.center.y = SCREEN_HEIGHT-(PADDLE_HEIGHT/2)
#This is to draw the paddle        
    def draw(self):
        arcade.draw_rectangle_filled(self.center.x, self.center.y, self.width, self.height, arcade.color.BLACK)
#This is to move the function up        
    def move_up(self):
        if self.center.y + (PADDLE_HEIGHT/2) < SCREEN_HEIGHT:
            self.center.y += MOVE_AMOUNT
            
#This moves the function down            
    def move_down(self):
